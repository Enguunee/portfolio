...
const Contact =()=> {
  ...
  //
  //
    emailjs.send('service_eov01pa', 'template_8r58v9p',
    {from_name: form.name,
    to_name: 'Eva',
    to_email: 'enkhgerel.batdorj@gmail.com',
  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse fkex gap-10 overflow-hidden">
      <motion.div 
...
className="mt-12 flex-1 flex-col gap-8">
